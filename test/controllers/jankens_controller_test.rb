...
class JankensControllerTest < ActionController::TestCase
  ...
  test "should create janken" do
    assert_difference('Janken.count') do
      post :create, janken: { cpu_hand: @janken.cpu_hand, result: @janken.result, your_hand: @janken.your_hand }
    end
  ...
  test "should update janken" do
    patch :update, id: @janken, janken: { cpu_hand: @janken.cpu_hand, result: @janken.result, your_hand: @janken.your_hand }
    assert_redirected_to janken_path(assigns(:janken))
  end
